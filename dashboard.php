    ...
    <main class="page-content" id="pageContent">
      ...
      <section class="page-section active" id="page-dashboard">
        <div class="row g-3 mb-4" id="statsGrid">
          <!-- Chargé via AJAX -->
          <div class="col-12 col-sm-6 col-lg-3"><div class="stat-card animate-in" style="animation-delay:.05s">
            <div class="stat-icon blue">📁</div>
            <div class="stat-value" id="stat-projects">–</div>
            <div class="stat-label">Projets actifs</div>
            <div class="stat-change up" id="stat-projects-change"></div></div><div class="col-12 col-sm-6 col-lg-3"><div class="stat-card animate-in" style="animation-delay:.1s">
            <div class="stat-icon green">✅</div>
            <div class="stat-value" id="stat-tasks-done">–</div>
            <div class="stat-label">Tâches terminées</div>
            <div class="stat-change up">↑ Ce mois</div></div><div class="col-12 col-sm-6 col-lg-3"><div class="stat-card animate-in" style="animation-delay:.15s">
            <div class="stat-icon yellow">⏳</div>
            <div class="stat-value" id="stat-tasks-progress">–</div>
            <div class="stat-label">Tâches en cours</div>
            <div class="stat-change down" id="stat-tasks-late"></div></div><div class="col-12 col-sm-6 col-lg-3"><div class="stat-card animate-in" style="animation-delay:.2s">
